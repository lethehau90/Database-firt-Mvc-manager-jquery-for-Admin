...
namespace Web_config_v1.Areas.Quanlywebsite.Controllers.TinTuc
{
    public class CategoryNewsAdminController : Controller
    {
        //
        // GET: /Quanlywebsite/CategoryNewsAdmin/
        ...
        {
            var data = connect_entity.GroupNews.OrderBy(x => x.Ord).Where(x => x.Level == null).ToList();
        ...
        public CategoryNewsAdminController()
        {
        ...
        public JsonResult Loadmenu_Lever2_muti_(string Id)
        {
            ...
            var data = connect_entity.GroupNews.OrderBy(x => x.Ord).Where(x => x.Level == lever).ToList();
            return Json(data, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            string lever = Lever2up_lever(Convert.ToInt32(Id));
            var data = connect_entity.GroupNews.OrderBy(x => x.Ord).Where(x => x.Id == Id).ToList();
            return Json(data, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult Loadmenu_Lever1_muti_(string Id)
        {
            ...
            var data = connect_entity.GroupNews.OrderBy(x => x.Ord).Where(x => x.Id == lever).ToList();
            return Json(data, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            var data = connect_entity.GroupNews.OrderBy(x => x.Ord).First(x => x.Id==Id);
            return data.Level;
        }
        ...
        public int Lever1up(int Id)
        {
            ...
            var data = connect_entity.GroupNews.OrderBy(x => x.Ord).First(x => x.Id == idlever1);
            return data.Id;
        }
        ...
        {
            var data = connect_entity.GroupNews.Find(Id);
            if (data.Active == 0)
                data.Active = 1;
        ...
        {
            var data = connect_entity.GroupNews.Where(x => x.Level.Equals(Id)).ToList();
        ...
        {
            var data = connect_entity.GroupNewsNewsDetails.Where(x => x.Cateprolevel3.Equals(tag)).ToList();
            string dem = data.Count.ToString();
            return Content(dem);
        }
        ...
        {
            var data = connect_entity.GroupNewsNewsDetails.Where(x => x.Cateprolevel2.Equals(tag) || x.Cateprolevel3.Equals(tag)).ToList();
            string dem = data.Count.ToString();
            return Content(dem);
        }
        ...
        {
            var data = connect_entity.GroupNewsNewsDetails.Where(x => x.Cateprolevel1.Equals(tag)).ToList();
            string dem = data.Count.ToString();
            return Content(dem);
        }
        ...
        public int Count_category(int Id) //đếm danh mục trả về kiểu số nguyên
        {
            ...
            var data = connect_entity.GroupNews.Where(x => x.Level == idd).ToList();
            int dem = data.Count;
            return dem;
        }
        ...
        {
            var Data_parent_level1 = connect_entity.GroupNewsNewsDetails.Where(x => x.Cateprolevel1 == tag).ToList(); //bind cấp cao nhất
        ...
        {
            var Data_parent_level2 = connect_entity.GroupNewsNewsDetails.Where(x => x.Cateprolevel2 == tag).ToList(); //bind cấp cao nhất
        ...
        {
            var Data_parent_level3 = connect_entity.GroupNewsNewsDetails.Where(x => x.Cateprolevel3 == tag).ToList(); //bind cấp cao nhất
